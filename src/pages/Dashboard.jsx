...
const moods = [
  ...
  },
  {
    label: "Relaxation",
    icon: Sunset,
    desc: "Beaches, spas & peaceful stays",
  ...
  },
  {
    ...
    desc: "Culinary journeys & food spots",
  ...
  },
  {
    label: "Nature",
    icon: Leaf,
    desc: "Mountains, forests & wildlife",
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 py-8 md:py-12 space-y-12 md:space-y-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="text-white/50 text-base max-w-md">
              Where are you heading next? Let AI craft your perfect trip in
              seconds.
            </p>
          </div>
          <button
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          {[
            ...
            },
            {
              ...
              label: "People Traveled",
              value: loading
                ? "-"
                : trips.reduce((acc, t) => acc + (t.people || 0), 0),
            },
          ].map((stat, i) => (
            <div
              key={i}
              className="bg-white/5 border border-white/10 rounded-2xl p-4 md:p-5 hover:bg-white/8 transition-all duration-200"
            >
        ...
        <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-2xl p-5 md:p-6 flex items-start gap-4">
          ...
          <div>
            <p className="text-purple-400 text-xs font-semibold uppercase tracking-widest mb-1.5">
          ...
          <div className="flex items-end justify-between mb-6">
            <div>
              ...
              <p className="text-white/40 text-xs mt-1">
                AI picks the best itinerary for your vibe
              </p>
            </div>
          </div>
        ...
        <div>
          <div className="flex items-end justify-between mb-6">
            <div>
              ...
              <p className="text-white/40 text-xs mt-1">
                Click any destination to plan instantly
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            {trending.map((dest, i) => (
              <button
                ...
                className="relative overflow-hidden rounded-2xl text-left hover:scale-105 transition-all duration-200 group h-48"
              >
                {/* Photo */}
                <img
                  src={getDestinationPhoto(dest.name)}
                  alt={dest.name}
                ...
                {/* Hover CTA */}
                <div className="absolute top-3 right-3 bg-white/20 backdrop-blur-sm border border-white/20 rounded-full px-3 py-1 text-white text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center gap-1">
                  <Plus size={10} />
                  Plan this
                </div>
              </button>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
              {trips.slice(0, 3).map((trip) => (
                ...
                >
                  ...
                  <h3
                    style={{ fontFamily: "'Playfair Display', serif" }}
                    className="text-xl font-black text-white mb-3 group-hover:text-purple-300 transition-colors duration-200"
                  >
                    {trip.destination}
                  </h3>
        ...
        {!loading && trips.length === 0 && (
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-white/40 text-sm mb-6">
              Plan your first AI generated trip and save it here.
            </p>
            <button
              onClick={() => navigate("/plan")}
