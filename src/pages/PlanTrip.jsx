...
if (loading) return <Loader />
  return (
    ...
    >
      ...
      {/* Form */}
      <div className="relative z-10 flex flex-col items-center px-6 pt-10 pb-24">
        <div className="inline-block bg-white/10 border border-white/20 text-white/70 text-xs font-medium px-4 py-1.5 rounded-full mb-6 tracking-widest uppercase">
          Plan Your Trip
        </div>
        ...
        <p className="text-white/50 text-base mb-12 text-center max-w-md font-light">
          Fill in the details below and our AI will generate a personalized
          itinerary for you.
        </p>

        <div className="w-full max-w-2xl bg-white/5 border border-white/10 rounded-3xl p-10 flex flex-col gap-6">
          {/* Destination */}
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="bg-white/10 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-purple-500 transition-colors duration-200"
            />
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <select
              ...
              value={form.budget}
              onChange={handleChange}
              className="bg-white/10 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-purple-500 transition-colors duration-200"
            >
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 disabled:opacity-50 text-white font-semibold text-base py-4 rounded-full shadow-lg shadow-purple-900/40 hover:scale-105 transition-all duration-200 mt-2"
          >
            Generate Itinerary
            <ArrowRight size={18} />
          </button>
